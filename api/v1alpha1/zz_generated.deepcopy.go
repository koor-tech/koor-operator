...
func (in *KoorClusterSpec) DeepCopyInto(out *KoorClusterSpec) {
	*out = *in
	...
	out.NotificationOptions = in.NotificationOptions
}
...
func (in *KoorClusterStatus) DeepCopyInto(out *KoorClusterStatus) {
	*out = *in
	...
	out.LatestVersions = in.LatestVersions
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NotificationOptions) DeepCopyInto(out *NotificationOptions) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NotificationOptions.
func (in *NotificationOptions) DeepCopy() *NotificationOptions {
	if in == nil {
		return nil
	}
	out := new(NotificationOptions)
	in.DeepCopyInto(out)
	return out
}
